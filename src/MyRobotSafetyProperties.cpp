...

{
    ...
    addEventToAllLevelsBetween(slMotorPowerOn, slSystemOn, emergency, slEmergency, kPublicEvent);
    addEventToAllLevelsBetween(slMotorPowerOn, slEmergency, abort, slShuttingDown, kPublicEvent);
